...
# Prompt de inicialización para el rol de Reviewer (sólo se envía una vez al modelo)
...
def llamar_reviewer(reviewer_input):
    ...
    # Llama a la API de OpenAI con el prompt de sistema sólo una vez (rol persistente)
    ...
    # Intenta extraer el JSON de evaluación estructurada
    try:
